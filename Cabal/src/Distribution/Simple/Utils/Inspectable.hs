...
-- | This module exposes the 'Inspectable' typeclass, used 
-- to to generate a JSON representation of almost any type that 
-- implements Generic.
--
-- Even functions and IO actions have instances, because we 
-- don't want to forbid givin 'Inspectable' instances to records
...
-- | Not much information can be extracted from functions...
...
instance (Inspectable a,
          ...
          Inspectable d,
          Inspectable e
          ) => Inspectable (a,b,c,d,e) where 
  toInspectionJSON (a,b,c,d,e) = Array [toInspectionJSON a, toInspectionJSON b, toInspectionJSON c, toInspectionJSON d, toInspectionJSON e]
...
-- Mostly a straight copy of Distribution.Client.Utils.Json
--
